...
function AddClientForm() {
  ...
  const handleSubmit = async (e: FormEvent<UserCustomForm>) => {
    ...
    const toastId = toast.loading("Creando nuevo cliente...");
    try {
      ...
      if (response?.id) {
        ...
        toast.error("Error al crear al nuevo cliente", { id: toastId });
      } else {
        toast.error("Error al crear al nuevo cliente", { id: toastId });
      }
    } catch (err) {
      ...
      <div className="bg-white py-3 px-8 rounded-lg border border-gray-200 mb-4 mt-20 shadow-md">
        <div className=" inset-0 flex items-start justify-between mb-2 mt-2">
          ...
          <div>
            <button
              ...
              className="flex items-center gap-1 rounded-md bg-sky-500  text-white ml-2 font-base px-4 py-2 text-sm  hover:bg-sky-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75"
            >
        ...
        <Transition appear show={isOpen} as={Fragment}>
          ...
          >
            ...
            <div className="fixed inset-0 overflow-y-auto text-gray-700">
